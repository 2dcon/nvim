...
* **LSP Reference Underlines**: Overrode the LSP document reference highlights (`LspReferenceText`/`Read`/`Write`) to use clean underlines instead of background blocks, preventing contrast and readability conflicts on dimmed/unused variables and functions.
